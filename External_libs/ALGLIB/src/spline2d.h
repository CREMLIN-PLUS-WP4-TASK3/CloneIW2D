...
namespace spline2d
{
    ...
    *************************************************************************/
    ...
    template<unsigned int Precision>
    void spline2dbuildbilinear(ap::template_1d_array< amp::ampf<Precision> > x,
    ...
    template<unsigned int Precision>
    void spline2dbuildbicubic(ap::template_1d_array< amp::ampf<Precision> > x,
        ap::template_1d_array< amp::ampf<Precision> > y,
        ap::template_2d_array< amp::ampf<Precision> > f,
        int m,
        int n,
        spline2dinterpolant<Precision>& c);
    template<unsigned int Precision>
    amp::ampf<Precision> spline2dcalc(const spline2dinterpolant<Precision>& c,
        amp::ampf<Precision> x,
        amp::ampf<Precision> y);
    template<unsigned int Precision>
    void spline2ddiff(const spline2dinterpolant<Precision>& c,
        amp::ampf<Precision> x,
        amp::ampf<Precision> y,
    ...
    template<unsigned int Precision>
    void spline2dunpack(const spline2dinterpolant<Precision>& c,
        int& m,
        int& n,
        ap::template_2d_array< amp::ampf<Precision> >& tbl);
    template<unsigned int Precision>
    void spline2dlintransxy(spline2dinterpolant<Precision>& c,
        amp::ampf<Precision> ax,
        amp::ampf<Precision> bx,
        amp::ampf<Precision> ay,
        amp::ampf<Precision> by);
    template<unsigned int Precision>
    void spline2dlintransf(spline2dinterpolant<Precision>& c,
        amp::ampf<Precision> a,
        amp::ampf<Precision> b);
    template<unsigned int Precision>
    void spline2dcopy(const spline2dinterpolant<Precision>& c,
        spline2dinterpolant<Precision>& cc);
    template<unsigned int Precision>
    void spline2dserialize(const spline2dinterpolant<Precision>& c,
        ap::template_1d_array< amp::ampf<Precision> >& ra,
        int& ralen);
    template<unsigned int Precision>
    void spline2dunserialize(const ap::template_1d_array< amp::ampf<Precision> >& ra,
        spline2dinterpolant<Precision>& c);
    template<unsigned int Precision>
    void spline2dresamplebicubic(const ap::template_2d_array< amp::ampf<Precision> >& a,
        int oldheight,
        int oldwidth,
        ...
        int newwidth);
    template<unsigned int Precision>
    void spline2dresamplebilinear(const ap::template_2d_array< amp::ampf<Precision> >& a,
        int oldheight,
        int oldwidth,
        ap::template_2d_array< amp::ampf<Precision> >& b,
        int newheight,
        int newwidth);
    template<unsigned int Precision>
    void bicubiccalcderivatives(const ap::template_2d_array< amp::ampf<Precision> >& a,
        const ap::template_1d_array< amp::ampf<Precision> >& x,
        const ap::template_1d_array< amp::ampf<Precision> >& y,
        int m,
        int n,
        ap::template_2d_array< amp::ampf<Precision> >& dx,
        ap::template_2d_array< amp::ampf<Precision> >& dy,
        ap::template_2d_array< amp::ampf<Precision> >& dxy);
    ...
    *************************************************************************/
        ...
        spline2dinterpolant<Precision>& c)
    {
        ...
        ap::ap_error::make_assertion(n>=2 && m>=2);
    ...
    *************************************************************************/
        ...
        spline2dinterpolant<Precision>& c)
    {
        ...
        bicubiccalcderivatives<Precision>(f, x, y, m, n, dx, dy, dxy);
        for(i=0; i<=m-1; i++)
        {
            for(j=0; j<=n-1; j++)
            {
    ...
    *************************************************************************/
        ...
        amp::ampf<Precision> y)
    {
        ...
        amp::ampf<Precision> vxy;


        spline2ddiff<Precision>(c, x, y, v, vx, vy, vxy);
        result = v;
        return result;
    }
    ...
    *************************************************************************/
        ...
        amp::ampf<Precision>& fxy)
    {
        ...
        int m;
        amp::ampf<Precision> t;
        amp::ampf<Precision> dt;
        amp::ampf<Precision> u;
        amp::ampf<Precision> du;
        int ix;
        int iy;
        int l;
        int r;
        ...
        int sfy;
        int sfxy;
        amp::ampf<Precision> y1;
        amp::ampf<Precision> y2;
        amp::ampf<Precision> y3;
        amp::ampf<Precision> y4;
        amp::ampf<Precision> v;
        amp::ampf<Precision> t0;
        amp::ampf<Precision> t1;
        amp::ampf<Precision> t2;
        amp::ampf<Precision> t3;
        amp::ampf<Precision> u0;
        amp::ampf<Precision> u1;
        amp::ampf<Precision> u2;
        amp::ampf<Precision> u3;


        ap::ap_error::make_assertion(amp::round<Precision>(c.c(1))==-1 || amp::round<Precision>(c.c(1))==-3);
        n = amp::round<Precision>(c.c(2));
        m = amp::round<Precision>(c.c(3));
        ...
        dt = amp::ampf<Precision>("1.0")/(c.c(l+1)-c.c(l));
        ix = l-4;
        ...
        du = amp::ampf<Precision>("1.0")/(c.c(l+1)-c.c(l));
        iy = l-(4+n);
        ...
        //
        if( amp::round<Precision>(c.c(1))==-1 )
        {
            shift1 = 4+n+m;
        ...
        //
        if( amp::round<Precision>(c.c(1))==-3 )
        {
            ...
            t0 = 1;
            t1 = t;
            t2 = amp::sqr<Precision>(t);
            t3 = t*t2;
            u0 = 1;
            u1 = u;
            u2 = amp::sqr<Precision>(u);
            u3 = u*u2;
            sf = 4+n+m;
            sfx = 4+n+m+n*m;
            sfy = 4+n+m+2*n*m;
    ...
    *************************************************************************/
        ...
        ap::template_2d_array< amp::ampf<Precision> >& tbl)
    {
        ...
        ap::ap_error::make_assertion(amp::round<Precision>(c.c(1))==-3 || amp::round<Precision>(c.c(1))==-1);
        n = amp::round<Precision>(c.c(2));
        m = amp::round<Precision>(c.c(3));
        ...
        for(i=0; i<=m-2; i++)
        {
            for(j=0; j<=n-2; j++)
            {
                ...
                for(ci=0; ci<=3; ci++)
                {
                    for(cj=0; cj<=3; cj++)
                    {
                        tbl(p,4+ci*4+cj) = tbl(p,4+ci*4+cj)*amp::pow<Precision>(dt, amp::ampf<Precision>(ci))*amp::pow<Precision>(du, amp::ampf<Precision>(cj));
                    }
                }
            }
        }
    ...
    *************************************************************************/
        ...
        amp::ampf<Precision> by)
    {
        ...
        typec = amp::round<Precision>(c.c(1));
        ap::ap_error::make_assertion(typec==-3 || typec==-1);
        n = amp::round<Precision>(c.c(2));
        m = amp::round<Precision>(c.c(3));
        x.setbounds(0, n-1);
        y.setbounds(0, m-1);
        ...
        if( ax==0 )
        {
            for(i=0; i<=m-1; i++)
            {
                v = spline2dcalc<Precision>(c, bx, y(i));
                for(j=0; j<=n-1; j++)
                {
                    f(i,j) = v;
                }
            ...
            if( typec==-3 )
            {
                spline2dbuildbicubic<Precision>(x, y, f, m, n, c);
            }
            if( typec==-1 )
            {
                spline2dbuildbilinear<Precision>(x, y, f, m, n, c);
            }
            ax = 1;
            bx = 0;
        }
        if( ay==0 )
        {
            for(j=0; j<=n-1; j++)
            {
                v = spline2dcalc<Precision>(c, x(j), by);
                for(i=0; i<=m-1; i++)
                {
                    f(i,j) = v;
                }
    ...
    *************************************************************************/
        ...
        spline2dinterpolant<Precision>& cc)
    {
        ...
        ap::ap_error::make_assertion(c.k==1 || c.k==3);
        cc.k = c.k;
        n = amp::round<Precision>(c.c(0));
        cc.c.setlength(n);
        amp::vmove(cc.c.getvector(0, n-1), c.c.getvector(0, n-1));
    }
    ...
    *************************************************************************/
        ...
        int& ralen)
    {
        ...
        ap::ap_error::make_assertion(c.k==1 || c.k==3);
        clen = amp::round<Precision>(c.c(0));
        ralen = 3+clen;
        ra.setlength(ralen);
        ra(0) = ralen;
        ra(1) = spline2dvnum;
        ra(2) = c.k;
        amp::vmove(ra.getvector(3, 3+clen-1), c.c.getvector(0, clen-1));
    }
    ...
    *************************************************************************/
        ...
        spline2dinterpolant<Precision>& c)
    {
        ...
        ap::ap_error::make_assertion(amp::round<Precision>(ra(1))==spline2dvnum);
        c.k = amp::round<Precision>(ra(2));
        clen = amp::round<Precision>(ra(3));
        c.c.setlength(clen);
        amp::vmove(c.c.getvector(0, clen-1), ra.getvector(3, 3+clen-1));
    }
    ...
    *************************************************************************/
    ...
    void spline2dresamplebicubic(const ap::template_2d_array< amp::ampf<Precision> >& a,
        ...
        int newwidth)
    {
        ap::template_2d_array< amp::ampf<Precision> > buf;
        ap::template_1d_array< amp::ampf<Precision> > x;
        ap::template_1d_array< amp::ampf<Precision> > y;
        ...
        ap::ap_error::make_assertion(oldwidth>1 && oldheight>1);
        ap::ap_error::make_assertion(newwidth>1 && newheight>1);
        ...
        for(i=0; i<=oldheight-1; i++)
        {
            ...
            {
                x(j) = amp::ampf<Precision>(j)/(amp::ampf<Precision>(oldwidth-1));
                y(j) = a(i,j);
            }
            ...
            //
            spline1d::spline1dbuildcubic<Precision>(x, y, oldwidth, 0, amp::ampf<Precision>("0.0"), 0, amp::ampf<Precision>("0.0"), c);
            for(j=0; j<=newwidth-1; j++)
            {
                buf(i,j) = spline1d::spline1dcalc<Precision>(c, amp::ampf<Precision>(j)/(amp::ampf<Precision>(newwidth-1)));
            }
        }
        ...
        for(j=0; j<=newwidth-1; j++)
        {
            ...
            for(i=0; i<=oldheight-1; i++)
            {
                x(i) = amp::ampf<Precision>(i)/(amp::ampf<Precision>(oldheight-1));
                y(i) = buf(i,j);
            }
            ...
            //
            spline1d::spline1dbuildcubic<Precision>(x, y, oldheight, 0, amp::ampf<Precision>("0.0"), 0, amp::ampf<Precision>("0.0"), c);
            for(i=0; i<=newheight-1; i++)
            {
                b(i,j) = spline1d::spline1dcalc<Precision>(c, amp::ampf<Precision>(i)/(amp::ampf<Precision>(newheight-1)));
            }
        }
    }
        ...
        int newwidth)
    {
        ...
        for(i=0; i<=newheight-1; i++)
        {
            for(j=0; j<=newwidth-1; j++)
            {
                ...
                u = amp::ampf<Precision>(i)/(amp::ampf<Precision>(newheight-1))*(oldheight-1)-l;
                c = j*(oldwidth-1)/(newwidth-1);
                if( c==oldwidth-1 )
                {
                    c = oldwidth-2;
                }
                t = amp::ampf<Precision>(j*(oldwidth-1))/(amp::ampf<Precision>(newwidth-1))-c;
    ...
    *************************************************************************/
        ...
        ap::template_2d_array< amp::ampf<Precision> >& dxy)
    {
        int i;
        int j;
        ap::template_1d_array< amp::ampf<Precision> > xt;
        ap::template_1d_array< amp::ampf<Precision> > ft;
        ap::template_1d_array< amp::ampf<Precision> > c;
        ...
        for(i=0; i<=m-1; i++)
        {
            ...
            spline3::buildcubicspline<Precision>(xt, ft, n, 0, amp::ampf<Precision>("0.0"), 0, amp::ampf<Precision>("0.0"), c);
            for(j=0; j<=n-1; j++)
            {
                spline3::splinedifferentiation<Precision>(c, x(j), s, ds, d2s);
                dx(i,j) = ds;
            }
        }
        ...
        for(j=0; j<=n-1; j++)
        {
            ...
            spline3::buildcubicspline<Precision>(xt, ft, m, 0, amp::ampf<Precision>("0.0"), 0, amp::ampf<Precision>("0.0"), c);
            for(i=0; i<=m-1; i++)
            {
                spline3::splinedifferentiation<Precision>(c, y(i), s, ds, d2s);
                dy(i,j) = ds;
            }
        }
