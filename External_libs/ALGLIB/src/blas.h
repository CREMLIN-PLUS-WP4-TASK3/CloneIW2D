...
namespace blas
{
        ...
        int jd2)
    {
        ...
        {
            idst = isrc-is1+id1;
            amp::vmove(b.getrow(idst, jd1, jd2), a.getrow(isrc, js1, js2));
        }
    }
        ...
        ap::template_1d_array< amp::ampf<Precision> >& work)
    {
        ...
        for(i=i1; i<=i2-1; i++)
        {
            ...
            jps = j1+ips-i1;
            l = i2-i;
            amp::vmove(work.getvector(1, l), a.getcolumn(j, ips, i2));
            amp::vmove(a.getcolumn(j, ips, i2), a.getrow(i, jps, j2));
            amp::vmove(a.getrow(i, jps, j2), work.getvector(1, l));
        }
    }
        ...
        int jd2)
    {
        ...
        {
            jdst = isrc-is1+jd1;
            amp::vmove(b.getcolumn(jdst, id1, id2), a.getrow(isrc, js1, js2));
        }
    }
        ...
        amp::ampf<Precision> beta)
    {
        ...
        if( !trans )
        {
            ...
            {
                amp::vmul(y.getvector(iy1, iy2), beta);
            }
            ...
            for(i=i1; i<=i2; i++)
            {
                v = amp::vdotproduct(a.getrow(i, j1, j2), x.getvector(ix1, ix2));
        ...
        else
        {
            ...
            {
                v = alpha*x(ix1+i-i1);
                amp::vadd(y.getvector(iy1, iy2), a.getrow(i, j1, j2), v);
            }
        }
    }
