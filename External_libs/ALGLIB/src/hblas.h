...
namespace hblas
{
    ...
    void hermitianmatrixvectormultiply(const ap::template_2d_array< amp::campf<Precision> >& a,
        bool isupper,
        int i1,
        int i2,
        const ap::template_1d_array< amp::campf<Precision> >& x,
        amp::campf<Precision> alpha,
        ap::template_1d_array< amp::campf<Precision> >& y);
    template<unsigned int Precision>
    void hermitianrank2update(ap::template_2d_array< amp::campf<Precision> >& a,
        bool isupper,
        int i1,
        int i2,
        const ap::template_1d_array< amp::campf<Precision> >& x,
        const ap::template_1d_array< amp::campf<Precision> >& y,
        ...
        ap::template_1d_array< amp::campf<Precision> >& y)
    {
        ...
        if( isupper )
        {
            for(i=i1; i<=i2-1; i++)
            {
                ...
                {
                    y(i_) = y(i_) + v*amp::conj(a(i,i_+i1_));
                }
        ...
        amp::campf<Precision> alpha)
    {
        ...
        if( isupper )
        {
            for(i=i1; i<=i2; i++)
            {
                ...
                {
                    t(i_) = v*amp::conj(y(i_));
                }
                v = amp::conj<Precision>(alpha)*y(i+1-i1);
                for(i_=tp1; i_<=tp2;i_++)
                {
                    t(i_) = t(i_) + v*amp::conj(x(i_));
                }
                i1_ = (tp1) - (i);
                for(i_=i; i_<=i2;i_++)
                {
