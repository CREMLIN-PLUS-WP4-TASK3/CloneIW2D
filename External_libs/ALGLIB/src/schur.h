...
namespace schur
{
    ...
    bool rmatrixschur(ap::template_2d_array< amp::ampf<Precision> >& a,
        int n,
    ...
    *************************************************************************/
        ...
        ap::template_2d_array< amp::ampf<Precision> >& s)
    {
        ...
        ap::template_2d_array< amp::ampf<Precision> > s1;
        int info;
        int i;
        int j;
        ...
        //
        ortfac::rmatrixhessenberg<Precision>(a, n, tau);
        ortfac::rmatrixhessenbergunpackq<Precision>(a, n, tau, s);
        ...
        hsschur::internalschurdecomposition<Precision>(a1, n, 1, 1, wr, wi, s1, info);
        result = info==0;
